...
> Full AI agency workflow powered by Claude Code
...
|---------|-------------|--------|
| Core — Full foundation for agency workflows | Core foundation — the primary abstraction this repo builds on | [docs](#) |
| Execution — task decomposition and agency routing | Execution layer — how tasks get decomposed and routed | [docs](#) |
| Integration — Claude Code + claude connectivity | Integration layer — connecting to external tools and APIs | [docs](#) |
...
```bash
# Quick start
python3 main.py --task "agency task here"

# Power user shortcut
python3 main.py --agency --fast
...
Use ai-agency-claude to automate full ai agency workflow powered by claude code. Perfect for agencies, freelancers, and AI-first teams running agency workflows at scale.
...
```bash
# Add to CLAUDE.md
echo "Auto-activate: agency, claude" >> ~/.claude/CLAUDE.md

# Or load skill directly
/load-skill ai-agency-claude
```
...
{
  "hooks": {
    "PostToolUse": [{"matcher": "agency", "command": "python3 ~/repos/ai-agency-claude/main.py"}]
  }
}
```
...
```bash
# Fork and clone
gh repo fork hmzainjamil/ai-agency-claude --clone
cd ai-agency-claude
